    ...
    <section class="flex justify-evenly items-center w-[40vw]">
      {footerIcons.map((value, index) => {
        return (
          <button
            key={index}
            class="group flex justify-evenly  rounded-md drop-shadow-xl bg-gradient-to-r from-gray-800 to-black text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
            href="/"
          >
            {value}
